...
**Diagnostics it can raise:** `bundle_adjustment_diverged`, `window_covers_model`, `did_not_converge`, `no_improvement`, `points_dropped_by_min_track_length`, `too_few_points`.
