...
| If | Fetch |
| --- | --- |
| a number is out of band, or a diagnostic told you to tune | **`tuning`** — 8 parameters documented, starting with `query_selection` |
...
**Diagnostics it can raise:** `no_tracks`, `poor_query_selection`, `thin_frame`, `heavy_duplication`, `mostly_occluded`.
